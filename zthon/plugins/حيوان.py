...
async def fetch_info(replied_user, event):
    ...
    if x == 1:
       ...
       caption += f"<b> 𓆩  𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐄𝐌𝐎 ➯ @SEMO8L 𓆪  "
...
async def who(event):
    ...
    zel_dev = (2095357462, 5560641134, 5365837256, 5680297831, 1951523146, 1243462298, 1037828349, 1985711199, 2028523456, 2045039090, 1764272868, 2067387667, 294317157, 2066568220, 1403932655, 1389046667, 444672531, 2055451976, 294317157, 2134101721, 1719023510, 1985225531, 2107283646, 2146086267, 1850533212, 5280339206)
    ...
    if replied_user.id == 5560641134 or replied_user.id == 5680297831 or replied_user.id == 5365837256:
